  ...
  return (
    <section className="relative flex overflow-hidden">
      ...
      <div className="flex-1 bg-white px-3 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-12 md:py-16 lg:py-24 xl:py-[120px] flex items-center justify-center">
        <div className="flex flex-col gap-4 sm:gap-5 md:gap-6 lg:gap-8 xl:gap-10 w-full max-w-3xl md:items-center">
          ...
          <ul className="flex flex-col gap-3 sm:gap-4 md:gap-5 lg:gap-6 xl:gap-8 text-base sm:text-lg md:text-2xl lg:text-3xl xl:text-[40px] leading-snug sm:leading-snug md:leading-snug lg:leading-10 xl:leading-11 font-medium text-[rgba(51,51,51,0.8)] text-left">
