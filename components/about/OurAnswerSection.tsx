      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-6 md:space-y-8 order-1 lg:order-2">
            {/* Heading */}
            <h2 className="font-shrikhand italic text-[#333] text-4xl md:text-5xl lg:text-6xl leading-tight">
              Our answer? Simple.
            </h2>

            {/* Description */}
            <p className="font-medium text-[#333] text-xl md:text-2xl leading-relaxed">
            ...
            <div className="bg-white border-2 border-[#333] rounded-[32px] px-6 md:px-8 py-6 md:py-9 space-y-5">
              <h3 className="font-bold text-[#333] text-lg md:text-xl">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-[#333] text-lg md:text-xl">Real roasted peanuts</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="bg-[#44C997] rounded-full w-7 h-7 flex items-center justify-center flex-shrink-0">
                    <span className="font-medium text-[#333]">✓</span>
                  </div>
                  <span className="font-medium text-[#333] text-lg md:text-xl">No palm oil</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="bg-[#44C997] rounded-full w-7 h-7 flex items-center justify-center flex-shrink-0">
                    <span className="font-medium text-[#333]">✓</span>
                  </div>
                  <span className="font-medium text-[#333] text-lg md:text-xl">No preservatives</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="bg-[#44C997] rounded-full w-7 h-7 flex items-center justify-center flex-shrink-0">
                    <span className="font-medium text-[#333]">✓</span>
                  </div>
                  <span className="font-medium text-[#333] text-lg md:text-xl">No complicated claims</span>
                </li>
              </ul>
            </div>
