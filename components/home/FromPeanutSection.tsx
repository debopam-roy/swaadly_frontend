...
export default function FromPeanutSection() {
  return (
    <section className="flex w-full">
      ...
      <div className="flex-1 bg-[#44c997] px-[60px] py-[80px] flex flex-col gap-8 justify-center">
        <div className="flex flex-col gap-6">
          <h2 className="font-bold text-[#333] text-[80px] leading-[84px]">
            From peanut to jar
          </h2>
          <p className="font-medium text-[#333] text-[32px] leading-[36px]">
